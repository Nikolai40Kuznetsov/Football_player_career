...
class FootballCareerSimulator(QMainWindow):
    ...
    def check_national_team_call(self):
        ...
        if self.player.nationality in ["Испания", "Англия", "Украина", "Россия", "Хорватия", "Польша", "Италия", "Германия", "Франция", "Португалия", "Нидерланды", "Бельгия"]:
            if year % 4 == 0:
                tournaments.append("Чемпионат Европы")
        elif self.player.nationality in ["Бразилия", "Мексика", "США", "Аргентина", "Уругвай", "Колумбия"]:
            if year % 4 == 1:
                tournaments.append("Кубок Америки")
        elif self.player.nationality in ["Япония", "Австралия", "Иран"]:
            if year % 4 == 2:
                tournaments.append("Кубок Азии")
        elif self.player.nationality in ["Египет", "Марокко", "Нигерия", "Тунис", "Сенегал"]:
            if year % 2 == 1:
    ...
    def check_milestones(self, stat_type, current_value):
        ...
        milestones = [1, 5, 10, 50, 100, 200, 300, 500, 1000]
        milestone_messages = {
            'matches': {
                ...
                200: "🌟 200 МАТЧЕЙ! Невероятная цифра!",
                300: "👑 300 МАТЧЕЙ! Героический результат!",
                500: "🏆 500 МАТЧЕЙ! Вписал свое имя в историю!",
                1000: "🚀 1000 МАТЧЕЙ! Абсолютная легенда!"
            },
            'goals': {
                ...
                200: "🌟 200 ГОЛОВ! Невероятный результат!",
                300: "👑 300 ГОЛОВ! Ты среди величайших!",
                500: "🏆 500 ГОЛОВ! Машина голов!", 
                1000: "🚀 1000 ГОЛОВ! Легендарный снайпер!" 
            },
            'assists': {
                ...
                500: "🏆 500 ПЕРЕДАЧ! Король голевых передач!", 
                1000: "🚀 1000 ПЕРЕДАЧ! Величайший плеймейкер!" 
            }
        }
    ...
    def show_create_player_dialog(self):
        ...
        nationalities = [
            "Россия", "Беларусь", "Казахстан", "Украина", "Польша", "Косово", "Испания",
            "Англия", "Италия", "Германия", "Франция", "Нидерланды", "Португалия", "Бельгия",
            "Хорватия", "Бразилия", "Аргентина", "Уругвай", "Колумбия", "США", "Мексика", 
            "Австралия", "Япония", "Иран", "Египет", "Марокко", "Нигерия", "Тунис", "Сенегал", 
        ]
